...
- Invariant (unit-test this): 10 pages/tile, 8 tiles/island. tile = min(totalPages/10, totalTiles−1). Island unlock + lighthouse on first reach. pages from minutes × pace.
- Empty: The water is empty. Place the first book.
- Fake that fails: A spine shelf or a % progress list.
